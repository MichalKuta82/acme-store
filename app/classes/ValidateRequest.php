...
class ValidateRequest
{
	...
	private static $error_messages = [
			...
			'mixed' => 'The :attribute field cannot contain special characters - letters, numbers, dash and space only',
 	...
 	* @param array $policies, the rules that validation must stisfy
 	*/
 	...
 	* @param $value, value passed to te form
